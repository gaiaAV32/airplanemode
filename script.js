        ...
        var airportFetchingAndWeather = function () {
          console.log("im Fetching airports and weather");
            $("#iata-Code").html(data.flightStatuses[0].departureAirportFsCode);
              ...
              $.getJSON("http://api.openweathermap.org/data/2.5/weather?lat="+latFrom+"&lon="+lonFrom, function(data){
              ...
              $.getJSON("http://api.openweathermap.org/data/2.5/weather?lat="+latTo+"&lon="+lonTo, function(data){
                  console.log(data.weather[0].description);
